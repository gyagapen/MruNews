...
public class SemdexListActivity extends Activity implements Runnable {
	...
	private ArrayList<SemdexEntity> semdexEntityList = null;
	...
	public void populateSemdexList(ArrayList<SemdexEntity> semdexList) {
		semdexListAdapter = new SemdexListAdapter(semdexList, this);
	...
	public void run() {
			...
			semdexEntityList = new ArrayList<SemdexEntity>();
			...
			try {
				...
				semdexEntityList = htmlParser.getSemdexList();
				isRefreshed = false;
	...
	public void finish() {
		...
		// stop asynctask
		if (semdexListAdapter != null) {
			semdexListAdapter.stopAllASyncTask();
		}
